...
const plans = [
  { name:"Free",nameEn:"Free",nameAr:"مجانية",slug:"free",sortOrder:10,maxProfiles:1,maxLinks:5,maxCustomFields:3,maxTags:1,maxCards:1,maxUploads:0,maxFiles:0,maxStorageBytes:0n,allowCustomSlug:false,customSlugAllowed:false,allowThemes:false,allowCustomTheme:false,allowAnalytics:false,analyticsAllowed:false,allowFileUploads:false,allowCustomIcons:false,availableProfileTypes:["PERSONAL"],availableThemes:["CLASSIC_DARK"] },
  { name:"Personal",nameEn:"Personal",nameAr:"شخصية",slug:"personal",sortOrder:20,maxProfiles:2,maxLinks:15,maxCustomFields:10,maxTags:2,maxCards:2,maxUploads:10,maxFiles:10,maxStorageBytes:52428800n,allowCustomSlug:true,customSlugAllowed:true,allowThemes:true,allowCustomTheme:false,allowAnalytics:true,analyticsAllowed:true,allowFileUploads:true,allowCustomIcons:false,availableProfileTypes:["PERSONAL"],availableThemes:["CLASSIC_DARK","CLASSIC_LIGHT"] },
  { name:"Pro",nameEn:"Pro",nameAr:"احترافية",slug:"pro",sortOrder:30,maxProfiles:5,maxLinks:50,maxCustomFields:30,maxTags:5,maxCards:5,maxUploads:50,maxFiles:50,maxStorageBytes:524288000n,allowCustomSlug:true,customSlugAllowed:true,allowThemes:true,allowCustomTheme:true,allowAnalytics:true,analyticsAllowed:true,allowFileUploads:true,allowCustomIcons:true,availableProfileTypes:["PERSONAL","PROFESSIONAL"],availableThemes:["CLASSIC_DARK","CLASSIC_LIGHT","ELEGANT_DARK","ELEGANT_LIGHT"] },
  { name:"Business",nameEn:"Business",nameAr:"أعمال",slug:"business",sortOrder:40,maxProfiles:25,maxLinks:250,maxCustomFields:100,maxTags:100,maxCards:100,maxUploads:500,maxFiles:500,maxStorageBytes:5368709120n,allowCustomSlug:true,customSlugAllowed:true,allowThemes:true,allowCustomTheme:true,allowAnalytics:true,analyticsAllowed:true,allowFileUploads:true,allowCustomIcons:true,availableProfileTypes:["PERSONAL","PROFESSIONAL","BUSINESS"],availableThemes:["CLASSIC_DARK","CLASSIC_LIGHT","ELEGANT_DARK","ELEGANT_LIGHT"] },
];
async function main() {
