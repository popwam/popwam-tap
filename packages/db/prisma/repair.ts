...
const profileTemplates = [
  { nameAr:"بسيط",nameEn:"Minimal",slug:"minimal",category:"Minimal",minimumPlan:"free",sortOrder:10,configuration:{background:"#111313",panel:"#191c1c",text:"#f5f5f5",muted:"#a3a3a3",accent:"#55d6a5",radius:"1.25rem",linkLayout:"list",avatarPosition:"start",headerAlign:"start",coverStyle:"minimal",contactLayout:"grid",desktopLayout:"narrow"} },
  { nameAr:"اجتماعي",nameEn:"Social",slug:"creator",category:"Social",minimumPlan:"personal",sortOrder:20,configuration:{background:"#171119",panel:"#281c2b",text:"#fff7fb",muted:"#c9b5c6",accent:"#f29ac1",radius:"2rem",linkLayout:"grid",avatarPosition:"center",headerAlign:"center",coverStyle:"full",contactLayout:"row",desktopLayout:"narrow"} },
  { nameAr:"احترافي",nameEn:"Professional",slug:"professional",category:"Professional",minimumPlan:"pro",sortOrder:30,configuration:{background:"#101419",panel:"#18202a",text:"#f8fafc",muted:"#9ca3af",accent:"#68d5ad",radius:"1rem",linkLayout:"compact",avatarPosition:"end",headerAlign:"end",coverStyle:"inset",contactLayout:"list",desktopLayout:"split"} },
  { nameAr:"معرض أعمال",nameEn:"Portfolio",slug:"portfolio",category:"Portfolio",minimumPlan:"pro",sortOrder:40,configuration:{background:"#0f1215",panel:"#171c21",text:"#f4f7fa",muted:"#9ba8b4",accent:"#8bd0de",radius:"0.75rem",linkLayout:"grid",avatarPosition:"center",headerAlign:"center",coverStyle:"banner",contactLayout:"grid",desktopLayout:"wide"} },
  { nameAr:"شركة",nameEn:"Company",slug:"business",category:"Business",minimumPlan:"business",sortOrder:50,configuration:{background:"#111313",panel:"#1a1d1d",text:"#ffffff",muted:"#a4aaaa",accent:"#e4b86a",radius:"0.75rem",linkLayout:"compact",avatarPosition:"start",headerAlign:"start",coverStyle:"banner",contactLayout:"list",desktopLayout:"split"} },
];
async function main() {
