...
export async function generateMetadata():Promise<Metadata>{const branding=await getBrandingSettings();return {
  title:{default:"POPWAM Tap",template:"%s · POPWAM Tap"},description:"Smart NFC and QR cards controlled securely from the cloud.",applicationName:"POPWAM Tap",manifest:"/manifest.webmanifest",
