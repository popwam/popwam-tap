...
private class FakeProfilesRepository(private val saveError:Exception?=null,private val loadError:Exception?=null,private val publishResult:ProfileMutationResult?=null):ProfilesRepository{
