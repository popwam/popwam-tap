...
data class ProfileTemplateDto(val id:String="",val nameAr:String="",val nameEn:String="",val slug:String="",val category:String="",val minimumPlan:String="free",val previewImageUrl:String?=null,val configuration:TemplateConfigurationDto=TemplateConfigurationDto(),val allowed:Boolean=true,val profileKind:String="",val family:String="",val variant:String="",val isActive:Boolean=true)
...
data class PublishingActionResponse(val ok:Boolean=false,val lifecycle:String?=null,val revisionNumber:Int?=null,val draftRevision:Int?=null,val idempotent:Boolean?=null,val readiness:PublishingReadinessDto?=null,val error:String?=null)
data class ProfileMediaAssetDto(val id:String="",val purpose:String="",val state:String="",val previewUrl:String?=null)
data class ProfileMediaUploadResponse(val ok:Boolean=false,val asset:ProfileMediaAssetDto?=null,val draftRevision:Int?=null,val error:String?=null)
...
data class ProfileQuotaDto(val used:Int=0,val limit:Int=1,val remaining:Int=0,val planSlug:String="free",val quotaAllowsAdditional:Boolean=false,val allowedProfileKinds:List<String> = listOf("PERSONAL"),val customSlugAllowed:Boolean=false,val allowedThemes:List<String> = emptyList(),val onboardingSupported:Boolean=false,val blocker:String?=null)
...
data class EditorServiceDto(val id:String="",val name:String="",val nameAr:String?=null,val nameEn:String?=null,val descriptionAr:String?=null,val descriptionEn:String?=null,val url:String?=null,val visibility:String="ONLY_ME",val itemType:String="SERVICE",val imageUrl:String?=null,val price:String?=null,val currency:String?=null,val category:String?=null,val featured:Boolean=false,val sortOrder:Int=0)
...
// Additive, default-denied for snapshots created before PASS 6.
data class StorefrontEntitlementsDto(
    val storefrontEnabled:Boolean=false, val storefrontProductsEnabled:Boolean=false,
    val storefrontServicesEnabled:Boolean=false, val storefrontMaxItems:Int?=null,
